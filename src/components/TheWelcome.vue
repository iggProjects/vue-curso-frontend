<script setup>
import WelcomeItem from './WelcomeHome/WelcomeItem.vue'
...
<div id="ppal" class="disp-col-center">
  <p>TheWelcome.vue ✔</p>
    ...
    <WelcomeItem>
      ...
      En el Contenidos del Programa FrontEnd, enero - abril 2022,
      </a>encontrarás la información necesaria para conocer los temas tratados en el curso dictado por el 
      <a href="https://www.linkedin.com/in/alberto-mozo-avellaned-80615713/" target="_blank">Profesor Alberto Mozo</a>,
    ...
    <WelcomeItem>
      ...
      Tutoriales y documentos relacionados con:<br>
      <table><tr>
    ...
    <WelcomeItem>
      ...
      <template #heading>Anexos</template>
...
<style scoped>
  #ppal { 
    ...
    height:90vh;
    width:800px;  
    /* border: 5px solid rgb(214, 213, 213); padding:3px; height:95vh; overflow-y: scroll; */
  }
